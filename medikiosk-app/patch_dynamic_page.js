...
export default function HistoryWizardPage() {
  ...
  const progressPct = Math.min(20 + (messages.length * 15), 100);
          ...
          <div className="px-margin-mobile pb-6 pt-4 bg-[#FFFCF5] rounded-t-3xl shadow-[0_-4px_24px_rgba(0,0,0,0.06)] relative z-20">
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
              {!isLoading && questionData.options?.map((opt: any) => (
                ...
                >
                  <span className="material-symbols-outlined text-[32px] text-[#D48C70] mb-2">{opt.icon || 'radio_button_unchecked'}</span>
...
console.log('Successfully wrote dynamic history page.tsx');
